...
**Generated:** 1/21/2026, 2:16:51 PM
**Total Source Files:** 45

🚨 **ARCHITECTURAL SMELLS DETECTED:** 6
...
| :--- | :---: | :---: | :--- |
| `src/systems/ThreatSystem.ts` | 224 | 🟡 WARNING |  |
...
| `src/data/EntityData.ts` | 179 | 🟢 HEALTHY |  |
| `src/systems/LifecycleSystem.ts` | 174 | 🟢 HEALTHY |  |
| `src/systems/JobExecutionSystem.ts` | 158 | 🟢 HEALTHY | Imports src/systems/jobs/HarvestRunner.ts (Spaghetti!), Imports src/systems/jobs/PatrolRunner.ts (Spaghetti!) |
| `src/ui/UIManager.ts` | 156 | 🟢 HEALTHY |  |
| `src/systems/jobs/PatrolRunner.ts` | 140 | 🟢 HEALTHY |  |
...
| `src/systems/JobDispatchSystem.ts` | 120 | 🟢 HEALTHY |  |
...
| `src/systems/render/SprigRenderer.ts` | 76 | 🟢 HEALTHY |  |
| `src/tools/TerrainTool.ts` | 74 | 🟢 HEALTHY |  |
| `src/core/Grid.ts` | 73 | 🟢 HEALTHY |  |
| `src/core/SpatialHash.ts` | 69 | 🟢 HEALTHY |  |
| `src/core/Config.ts` | 65 | 🟢 HEALTHY |  |
| `src/services/CombatService.ts` | 65 | 🟢 HEALTHY |  |
...
| `src/systems/render/StructureRenderer.ts` | 59 | 🟢 HEALTHY |  |
